...
abstract class PaymentGateway
{
    ...
    public function submitPayment()
    {
        ...
        echo "<html>\n";
        echo "<head><title>Bezig met betaling.</title></head>\n";
        echo "<body onLoad=\"document.forms['gateway_form'].submit();\">\n";
        echo "<p style=\"text-align:center;\"><h2>Even geduld aub, je wordt nu doorgestuurd naar paypal website";
        echo "</h2></p>\n";
        ...
        echo "<p style=\"text-align:center;\"><br/><br/>Als je niet automatisch wordt doorgestuurd";
        echo " binnen 5 seconden<br/><br/>\n";
        echo "<input type=\"submit\" value=\"Klik hier\"></p>\n";
