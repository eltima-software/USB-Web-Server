...
Begin VB.Form Form1 
   ...
   Begin VB.Frame frm_smtp 
      ...
      Begin VB.Label Label23 
         BackStyle       =   0  'Transparent
         Caption         =   "Free SMTP Server - SoftStack.com"
         ForeColor       =   &H00444343&
         Height          =   255
         Left            =   1200
         TabIndex        =   45
      ...
      Begin VB.Label Label24 
         ...
         Width           =   1935
      End
      Begin VB.Label lbl_status_smtp 
         BackStyle       =   0  'Transparent
         Caption         =   "Opstarten..."
         BeginProperty Font 
            Name            =   "MS Sans Serif"
      ...
      Begin VB.Image smtp_start 
         ...
         Width           =   1095
      End
      Begin VB.Image smtp_stop 
         Height          =   405
         Left            =   480
         Picture         =   "Form1.frx":564B
         Top             =   960
         Visible         =   0   'False
         Width           =   1095
      End
      Begin VB.Image smtp_yellow 
         Height          =   405
         Left            =   480
         Picture         =   "Form1.frx":7250
         Top             =   960
         Width           =   1095
      End
   End
...
Private Sub Image12_Click()
    ...
    lay_menu_smtp.ForeColor = &HFFFFFF
...
Private Sub smtp_but_stat_Click()
    If (smtp_start.Visible = True) Then
        Call smtp_start_Click
    ElseIf (smtp_stop.Visible = True) Then
        Call smtp_stop_Click
    End If
End Sub

Private Sub smtp_start_Click()
    Shell "smtp/localsrv_usbwv8.exe", vbHide
    smtp_but_stat.Caption = "...."
    smtp_start.Visible = False
    smtp_stop.Visible = False
    Timer1.Enabled = False
    Timer1.Interval = 1000
    Timer1.Enabled = True
...
Private Sub smtp_stop_Click()
    killprocess ("localsrv_usbwv8.exe")
    smtp_but_stat.Caption = "...."
    smtp_start.Visible = False
    smtp_stop.Visible = False
    Timer1.Enabled = False
...
Private Sub Image7_Click()
    Shell "mysql/bin/mysqld_usbwv8.exe", vbHide
    Call Timer1_Timer
End Sub
...
Private Sub Form_Load()
    ...
    frm_smtp.Top = frm_alg.Top
    frm_smtp.Left = frm_alg.Left
    frm_smtp.Visible = False
...
Private Sub Label23_Click()
    browse ("http://www.softstack.com/freesmtp.html")
End Sub
...
Private Sub lay_menu_smtp_Click()
...
Private Sub lay_menu4_Click()
    ...
    lay_menu_smtp.ForeColor = &H80000012
...
Private Sub Timer1_Timer()
    ...
    If (IsProcessRunning("localsrv_usbwv8.exe") = True) Then
        status_smtp.Picture = status_green.Picture
        lbl_status_smtp.Caption = "Online"
        lbl_status_smtp.ForeColor = &HFF00&
        smtp_start.Visible = False
        smtp_but_stat.Caption = "STOP"
        smtp_stop.Visible = True
    Else
        status_smtp.Picture = status_red.Picture
        lbl_status_smtp.Caption = "Offline"
        lbl_status_smtp.ForeColor = &HFF&
        smtp_but_stat.Caption = "START"
        smtp_start.Visible = True
        smtp_stop.Visible = False
    End If
